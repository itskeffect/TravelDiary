    ...
    render(){
        if(this.props.cat==="Asia"){
            return(
                <Link to="/asia/asia-1">
                    <div className="card scale">
                        <img src={require(`../Assets/${AsiaArticle[0].pic}`).default} alt={AsiaArticle[0].title}/>
                        <h2>
                            {AsiaArticle[0].title}
                        </h2>
                        <p className="content">
            ...
            return(
                ...
                <div className="card">
                    <img src={require(`../Assets/${ParisArticle[0].pic}`).default} alt={ParisArticle[0].title}/>
                    <h2>
            ...
            return(
                <Link to="/america/america-1">
                    <div className="card">
                    <img src={require(`../Assets/${AmericaArticle[0].pic}`).default} alt={AmericaArticle[0].title}/>
                    <h2>
